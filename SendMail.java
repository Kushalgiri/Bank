...
public class SendMail {
	...
	System.out.println("Do You Want BankStatement in Mail?(true/false)\n");
			...
			if(inp==true) {
				...
				final String username = "kush.giri.457@gmail.com"; // enter your mail id
				...
				Session session = Session.getInstance(props,
				  ...
				  new		  javax.mail.Authenticator() {
					...
					try {
						...
						message.setFrom(new InternetAddress("kush.giri.457@gmail.com")); // same email id
						...
						try {
							...
							pdf.attachFile("C:\\Users\\kushg\\statement.pdf");
			...
			System.out.println("Bankstatement has not been send");	
